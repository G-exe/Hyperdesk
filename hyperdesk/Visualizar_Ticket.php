			...
			<div class="card card-outline card-success">
				...
				<div class="card-body">
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6">
								<label for="" class="control-label border-bottom border-primary">Assunto</label>
							...
							<div class="col-md-6">
								...
								<p class="ml-2 d-list">
									...
									<span class="badge btn-outline-primary btn update_status" data-id = '<?php echo $id ?>'>Atualizar o status</span>
									<?php endif; ?>
								</p>
								<label for="" class="control-label border-bottom border-primary">Departamento</label>
								...
								<div class="card-tools">
									...
									<span class="dropleft">
										...
										<div class="dropdown-menu">
									        ...
									        <a class="dropdown-item delete_comment" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">Deletar</a>
									     </div>
									</span>	
								<?php endif; ?>
								</div>
					...
					<div class="px-2">
						<form action="" id="manage-comment">
							<div class="form-group">
								...
								<label for="" class="control-label">Novo comentário</label>
								<textarea name="comment" id="" cols="30" rows="" class="fom-control summernote2"></textarea>
							</div>
							<button class="btn btn-primary btn-sm float-right">Salvar</button>
						</form>
					</div>
				</div>
			</div>
	...
	$('#manage-comment').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast('Comentário adicionado.',"success");
					setTimeout(function(){
						location.reload()
					},1500)
				}
